...
Provide secure, platform-specific storage for API authentication credentials (passwords, cookies, tokens) that is isolated from other applications and survives app restarts.
