...
## Purpose
TBD - created by archiving change add-unified-version-management. Update Purpose after archive.
## Requirements
...
The engine SHALL expose a `/status` endpoint returning version information.
