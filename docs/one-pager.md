...
1. **Broad usability** for the majority of people
2. **Minimal costs** to start and operate
...
- Fully open source: free to use and adjust
- Support for major platforms (web, desktop, mobile)
- Self-hosting on common hardware is the primary use case
- Easy to understand and operate with minimal help
- No external service, account, API-Key or payment is needed

### Technical decisions

- Resource efficient proven components
	- Local inference (chat completions API) and data processing
	- Python and Flutter software stacks for interoperability
	- Opentelemetry for observability
- Simple data structures (YAML files)
- Ready to use packages to download and run (containers, compiled apps)
