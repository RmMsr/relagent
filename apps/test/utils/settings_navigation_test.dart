...
void main() {
  ...
  test(
    'not dirty when draft matches settings and extra check reports nothing pending',
    () {
      expect(
        isSettingsDirty(
          draft: saved,
          settings: saved,
          hasExtraPendingChanges: () => false,
        ),
        isFalse,
      );
    },
